  ...
  return (
    <footer className="bg-luxury-black text-white pt-20 pb-10">
      <div className="container-custom grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 border-b border-white/10 pb-16">
        ...
        {/* Company */}
        <div className="space-y-6">
          <Link href="/company" className="inline-block">
            <h3 className="text-lg font-heading text-gold hover:text-yellow-400 transition-colors cursor-pointer">Company</h3>
          </Link>
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-4 text-sm text-gray-400">
            ...
            <li className="flex items-center space-x-3">
              ...
              <span>+213 676 346 072</span>
            </li>
            <li className="flex items-center space-x-3">
              <Mail size={18} className="text-gold shrink-0" />
              <span>bezzaamina31@gmail.com</span>
            </li>
          </ul>
        </div>
      </div>
